...
public class CreateJobAPITest {
	...
	public void createJobAPITest() throws IOException {
		...
		CustomerAddress customerAddress = new CustomerAddress("2A", "TSH", "ABC Street", "near SS SWIMMING POOL", "LPI",
				"530002", "IN", "TG");
		CustomerProduct customerProduct = new CustomerProduct(DataTimeUtil.getTimeWithDaysAgo(10), "87061348153531",
				"87061348153531", "87061348153531", DataTimeUtil.getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
				Model.NEXUS2_BLUE.getCode());
		...
		CreateJobPayload createJobPayload = new CreateJobPayload(ServiceLocation.SERVICE_LOCATION_A.getCode(),
				Platform.FRONTDESK.getCode(), Warranty_Status.IN_WARRANTY.getCode(), OEM.GOOGLE.getCode(), customer,
